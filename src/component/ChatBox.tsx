...
const ChatBox = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response: any = await fetch('http://localhost:8082/api/user-chat/stream', {
                method: "POST",
                headers: {
        ...
        <div className="flex flex-col h-screen bg-slate-50">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-teal-500 to-teal-600 text-white shadow-lg">
                ...
                <div className="flex items-center space-x-2">
                    <button className="p-2 text-teal-100 hover:text-white hover:bg-teal-600 rounded-lg transition-colors">
                ...
                <div className="max-w-4xl mx-auto px-4">
                    {messages.length === 1 && (
                        <div className="flex flex-col items-center justify-center h-full py-12 px-4">
                            ...
                            <p className="text-gray-500 text-center max-w-md">I'm here to answer questions, help with tasks, and provide code examples when needed.</p>
                        </div>
                    )}
